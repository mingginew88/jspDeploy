...
public class ElServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("sameName", "sessiontName");
		
		//application
		ServletContext sertvletContext = getServletContext();
		sertvletContext.setAttribute("applicationScop", "applicationValue");
		sertvletContext.setAttribute("sameName", "applicationName");
