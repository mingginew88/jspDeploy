...
// 		            document.getElementById("zipcdLabel").innerHTML = data.zonecode;
// 		            document.getElementById("addr1Label").innerHTML = data.address;
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="frm" action="/studentUpdate" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input id="addr2Label" type="text" class="form-control" id="addr2" name="addr2"
